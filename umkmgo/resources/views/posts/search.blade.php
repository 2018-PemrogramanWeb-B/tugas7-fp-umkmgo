...
<main role="main">
  <section class="jumbotron text-center container">
    <div class="container">
      <h1 class="jumbotron-heading">PRODUK POPULER</h1>
    </div>
  </section>
    ...
    {{-- dropdown section --}}
      {{-- <div class="dropdown pb-3">
        ...
        <div class="dropdown pb-3">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="/search/makanan">Makanan dan Minuman</a>
              <a class="dropdown-item" href="/search/kerajinan">Kerajinan Tangan</a>
              <a class="dropdown-item" href="/search/jasa">Lain Lain</a>
            </div>
          </div> 
        {{-- dropdown section --}}
      <div class="row">
